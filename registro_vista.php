...
<body class="d-flex justify-content-center align-items-center mt-5 p-3">
    <form action="./registro_vista.php" method="post" class="w-25 p-4">
        ...
        <div class="input-group mt-3 c-input px-2 p-1 rounded-3">
            <i class="bi bi-calendar-fill fs-3 text-dark mx-1"></i>
            <input type="number" class="form-control" placeholder="Ingrese su fecha de ingreso" id="ingreso" name="ingreso" value="">
        </div>
        <div class="input-group mt-3 c-input px-2 p-1 rounded-3">
            <i class="bi bi-envelope-fill fs-3 text-dark mx-1"></i>
            <input type="text" class="form-control" placeholder="Ingrese su carrera" id="carrera" name="carrera" value="">
        </div>
        <div class="input-group mt-3 c-input px-2 p-1 rounded-3">
            <i class="bi bi-date-fill fs-3 text-dark mx-1"></i>
            <input type="date" class="form-control" placeholder="Ingrese su fecha de nacimiento" id="nacimiento" name="nacimiento" value="">
        </div>
